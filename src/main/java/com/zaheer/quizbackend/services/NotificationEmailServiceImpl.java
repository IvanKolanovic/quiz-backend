...
public class NotificationEmailServiceImpl implements NotificationEmailService {
    ...
    public void sendConfirmationEmailOnPasswordChange(User user) {
        String emailText = "<p>Dear " + user.getFirstName() + ", your password was successfully changed on " + LocalDate.now() + " : " + LocalDateTime.now() +
                ...
                "<a href='https://www.quiz.marko-juric.from.hr/auth/login'>Login Panel</a>" +
                "<p>~Your Flaginator Team</p>";
    ...
    public void sendConfirmationEmailOnRegistration(User user) {
        String emailText = "<p>Dear " + user.getFirstName() + " your have successfully created an account on Flaginator online quiz." +
                "<br> You can now login with your email and the password you provided</p>"+"<br>"+
